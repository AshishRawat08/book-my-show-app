      ...
      <div className="container mx-auto px-4 my-10">
        <div className="w-full flex flex-col-reverse lg:flex-row-reverse gap 4">
          ...
          <div className="flex flex-wrap ">
            ...
            <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3 flex items-center">
              <Poster
                isPlay={true}
                c="https://assets-in.bmscdn.com/nmcms/events/banner/desktop/media-desktop-sunburn-arena-ft-dj-snake-delhi-ncr-0-2022-8-19-t-11-31-17.jpg"
                title="So rude to be Sweets"
                subtitle="Comedy Shows |  English, Hindi | 18+ | 2hr 18mins"
              />
            </div>
        ...
        <div className="lg:w-1/4 p-4 bg-white rounded">
          ...
          <div>
            <PlayFilters
              title="Language"
              tags={["English", "Hindi", "Telgu", "kannada"]}
            />
          </div>
        </div>
      </div>
